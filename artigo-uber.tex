...
\begin{resumo} 
	...
	Argumentos sobre como a empresa Uber, hoje responsável por transporte de passageiros e entrega de encomendas lida com o tratamento de dados nas aplicações desenvolvidas, conhecendo sobre a metodologia e linguagem de desenvolvimento.
...
Estudos realizados pelo IBGE afirma que entre os 12 milhões de trabalhadores desempregados têm como alternativa de trabalho o app, que passou de fevereiro de 2016 a janeiro de 2017 de 1 milhão de usuário para 8,7 milhões, ajudando assim os trabalhadores a usarem o aplicativo como renda extra e principalmente como trabalho principal gerando até 6 mil reais por mês de trabalho. 

Atualmente existem 50 milhões de clientes usuários do aplicativo no mundo todo, dados apontam que no Brasil desde 2014 foram realizadas em torno de 530 milhões de viagens em todo o território nacional, superando em 2016 a liderança da Cidade do México.
