...
Arquitetura de software tem emergido como uma importante pratica no desenvolvimento e na Engenharia de Software. 
...
Aplicações podem ser classificadas como monolíticas, funcionalidades são agrupadas dentro de um único e grande sistema,
...
flexibilidade, escalabilidade limitada e principalmente a falhas, se um módulo estiver com erro todo o sistema cai, 
causando uma interdependia grande entre os módulos do sistema. Grandes soluções atualmente tem como alterativa a arquitetura 
